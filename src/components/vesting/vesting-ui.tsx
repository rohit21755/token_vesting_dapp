...
export function VestingCreate() {
  ...
  function handleCreate() {
    if (publicKey && isFormValid) {
      createVestingAccount.mutateAsync({ companyName: companyName, mint: mint });
    }
  }
  if (!publicKey) {
  ...
  return (
    <>
    <input className="input input-bordered w-full max-w-xs" type='text' placeholder='Company Name' onChange={(e)=> setCompanyName(e.target.value)}/>
    <input className="input input-bordered w-full max-w-xs" type='text' placeholder='Mint' onChange={(e)=> setMint(e.target.value)}/>
    <button
